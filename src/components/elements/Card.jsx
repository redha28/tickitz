  ...
  return (
    <div className="flex flex-col gap-2 justify-between ">
      <div
        ...
        <div className="absolute hidden rounded-md group-hover:flex bg-black/60 w-full h-full flex-col items-center justify-center gap-4">
          <Button
            title="Details"
      ...
      {isLoading ? (
        ...
        <div className="flex gap-2 flex-wrap h-12">
          {filteredGenre(allGenre, dataGenre).map((data) => {
            return (
              <div
                key={data.id}
